	...
	$.PFold.prototype = {
		...
		_updateStepStyle : function( action ) {
			...
			if( action === 'fold' ) {
				...
				l = this.lastDirection === 'left' ? this.lastStyle.left + this.lastStyle.width / 2 : this.lastStyle.left-100,
				t = this.lastDirection === 'top' ? this.lastStyle.top + this.lastStyle.height / 2  : this.lastStyle.top+100;
				...
				t = this.lastDirection === 'top' ? this.lastStyle.top - this.lastStyle.height : this.lastStyle.top+100;	
