...
class MusicsControllerTest < ActionController::TestCase
  ...
  test "should create music" do
    assert_difference('Music.count') do
      post :create, music: { color: @music.color, description: @music.description, imageUrl: @music.imageUrl, musician: @music.musician, title: @music.title, videoUrl: @music.videoUrl }
    end
  ...
  test "should update music" do
    patch :update, id: @music, music: { color: @music.color, description: @music.description, imageUrl: @music.imageUrl, musician: @music.musician, title: @music.title, videoUrl: @music.videoUrl }
    assert_redirected_to music_path(assigns(:music))
  end
